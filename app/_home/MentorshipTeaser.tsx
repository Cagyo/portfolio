        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap items-center gap-3 mb-3">
              ...
              <span className="text-white/25 text-xs">· Limited spots per cohort</span>
            </div>
            <h3 className="font-heading font-black text-2xl text-white mb-2">Build real. Ship fast. Get hired.</h3>
            <p className="text-white/50 text-sm leading-relaxed max-w-lg">
              Production-grade full-stack development — TypeScript, NestJS, Next.js, React Native. You leave with working software and a GitHub repo that proves it.
            </p>
          </div>
