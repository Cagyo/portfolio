    ...
    <section id="projects" className="py-16 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="reveal text-white/50 mb-16 max-w-xl">
          A selection of projects I&apos;ve shipped — from side experiments to production systems serving millions of users.
        </p>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* SaaS Analytics — featured */}
          <ProjectCard
            title="SaaS Analytics Platform"
            description="Real-time analytics dashboard for e-commerce. Processes events at massive scale with sub-100ms query latency. Built with Next.js, ClickHouse, and Redis."
            meta={{ category: "SaaS", role: "Lead Engineer · Full Stack", year: "2022 – Now" }}
            badge={{ iconPath: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6", label: "50M+ events/day · sub-100ms queries" }}
            tags={["Next.js", "ClickHouse", "Redis", "Kafka", "TypeScript"]}
          ...
          <ProjectCard
            title="Auth Kit"
            description="Drop-in authentication library with 15+ providers, built for any Node.js stack."
            meta={{ category: "Open Source", role: "Creator", year: "2021 – 2023" }}
            badge={{ iconPath: "", label: "2,400+ stars" }}
            tags={["TypeScript", "OAuth2", "JWT"]}
            ...
            linkOverlay={VIEW_LIVE_SM}
          />

          {/* FinTrack */}
          <ProjectCard
            title="FinTrack Dashboard"
            description="Personal finance tracker with AI-powered categorization and forecast charts."
            meta={{ category: "Fintech", role: "Solo Build", year: "2022" }}
            badge={{ iconPath: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", label: "AI-powered · real-time sync" }}
            tags={["React", "Recharts", "AI"]}
          ...
          <ProjectCard
            title="DevPulse"
            description="GitHub activity monitor with smart digest notifications. Available on iOS & Android."
            meta={{ category: "Dev Tools", role: "Solo Build", year: "2021 – Now" }}
            badge={{ iconPath: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z", label: "500+ daily users" }}
            tags={["Node.js", "React Native", "GitHub API"]}
            imageBg="bg-gradient-to-br from-rose-900/30 to-transparent"
            imageContent={
              <MonitorIcon className="w-24 h-24 text-rose-400/60" />
            }
            linkOverlay={STORES_OVERLAY}
          />

          {/* Codebase AI */}
          <ProjectCard
            title="Codebase AI"
            description="AI code review assistant integrated into CI pipelines. Cuts PR review time significantly."
            meta={{ category: "AI / DevTools", role: "Co-creator", year: "2023" }}
            badge={{ iconPath: "M13 10V3L4 14h7v7l9-11h-7z", label: "40% faster code reviews" }}
            tags={["Python", "OpenAI", "CI/CD"]}
