...
export async function MentorshipHero() {
  ...
  return (
    ...
    >
      ...
      <BlobBackground size="w-80 h-80" color="bg-violet-500" position="bottom-20 -right-24" opacity="0.10" delay="3s" />
      <BlobBackground size="w-64 h-64" color="bg-violet-800" position="top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" opacity="0.08" delay="1.5s" />
